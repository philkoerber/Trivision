  ...
  return (
    <AnimatePresence>
      <div className='absolute bottom-[10%] md:bottom-[5%] flex justify-center items-center flex-col w-full '>
        <div className='w-full max-w-[600px] overflow-y-scroll overflow-x-hidden max-h-[40vh] md:max-h-[33.3vh] bg-gray-500 rounded flex justify-center items-center'>
          <motion.div
            ...
            style={{
              ...
              filter: 'contrast(0.3) brightness(2) invert(1)',
            }}
          >
